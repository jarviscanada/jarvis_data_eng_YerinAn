...
public interface JList<E> {
   ...
   * More formally, returns <tt>true</tt> if and only if this list contains at least one element <tt>e</tt> such that
   ...
   * @throws IndexOutOfBoundsException if the index if out of range (<tt>index &lt; 0 || index %gt;= size()</tt>
   */
  E get(int index);
