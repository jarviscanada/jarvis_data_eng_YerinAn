...
public class TraderAccountController {
  ...
  notes = "Delete a trader if its account amount is 0 no open positions"
  ...
  notes = "Withdraw a fund from the account that associates with the given traderId, withdraw")
  @ApiResponses(value = {
      @ApiResponse(code = 404, message = "traderId is not found"),
      @ApiResponse(code = 400, message = "Unable to deposit due to user input")})
  @ResponseStatus(HttpStatus.OK)
